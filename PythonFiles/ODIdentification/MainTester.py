...
with open(inputFileName, 'r') as inputFile:
    ...
    for inputLine in reader:
        ...
        print(str(float(time.time() - startTime))[:5])
        print("\n" + str(TripCounter))
